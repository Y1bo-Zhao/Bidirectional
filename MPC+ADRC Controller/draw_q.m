...
% 绘制图形
figure;
plot(t_extended, cos_theta_extended, 'LineWidth', 1, 'DisplayName', 'Actual cos(\theta)');
hold on;
plot(t_extended, expected_value_extended, 'r', 'LineWidth', 1, 'DisplayName', 'Expected Value');
hold off;
